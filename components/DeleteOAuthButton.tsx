...
export default function DeleteButton({ appId, appName }: DeleteButtonProps) {
    ...
    return (
      <div className="fixed inset-0 bg-black/50 backdrop-blur-sm flex items-center justify-center z-50">
        <div className="bg-[#0a0a0f] border border-red-500/30 rounded-2xl p-6 max-w-md mx-4 shadow-2xl">
          ...
          <h3 className="text-xl font-bold mb-2 text-center">Delete OAuth App?</h3>
          <p className="text-gray-400 mb-6 text-center">
            Are you sure you want to delete <strong className="text-white">{appName}</strong>?
